...
public class TestaJPQL {
	...
	public static void main(String[] args) {
		...
		// Ainda há resquícios do modelo relacional
		// String quey_jpql = "select m from Movimentacao m where id = 2";
		// String quey_jpql = "select m from Movimentacao m where m.conta = :conta";
